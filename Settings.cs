...
namespace Библиотеки
{
    public abstract class Settings
    {
        ...
        {
            string path = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\" + file + ".dat";
        ...
        {
            Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\");
            string path = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\" + file + ".dat";
        ...
        {
            string patha = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\" + file + ".dat";
        ...
        {
            DeleteSetting(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\" + file + ".dat", false);
        }
        /// <summary>
        /// Удалить файл настроек
        /// </summary>
        ...
        {
            ReplaceSetting(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\" + file + ".dat", newpath, false);
        }
        /// <summary>
        /// Импортирует файл настроек
        /// </summary>
        ...
        {
            ReplaceSetting(newpath, Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MicrofDev\\BookKipers\\" + file + ".dat");
        }
    }
}
